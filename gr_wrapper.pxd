cdef extern from "CKerr.h":
    ...
    # kerrtraj.c: Particle trajectories in Kerr. The first four are called in sm_axis_rng  
    ...
    # resonance_find.c: finding the apocenter that satisfies the resonance condition for a circular, equitorial orbiting perturber 
